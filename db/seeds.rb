...
User.create(name: "abc", email: "prina.2211@gmail.com", designation: "developer", gender: 1, date_of_joining: Date.parse('2016-03-04'), date_of_birth: Date.parse('1999-03-02'),role_id: 2, password: "123456", confirmed_at: Date.today )